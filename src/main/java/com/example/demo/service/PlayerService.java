...
public class PlayerService {
  ...
  /*  public Player partialUpdate(Long id, Player player) {
        ...
        if (player.getMaxSpeed() != 0) {
            playerToUpdate.setMaxSpeed(player.getMaxSpeed());
        }
        if (player.getAcceleration() != 0) {
            playerToUpdate.setAcceleration(player.getAcceleration());
        }
        ...
        if (player.getWeakFoot() != null) {
            playerToUpdate.setWeakFoot(player.getWeakFoot());
        }
